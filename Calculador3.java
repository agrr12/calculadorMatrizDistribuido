...
public class Calculador3{
	...
	public static void main( String[] args) {
        try {
            ...
            System.out.println("3| Aguardando uma conexão ...");
            Socket socket = server.accept();
            System.out.println("3| Aguardando um objeto ...");
            ObjectInputStream leitor = new ObjectInputStream(socket.getInputStream());
            MatrizPacote mp = (MatrizPacote) leitor.readObject();
            System.out.println("3 | Recebida a Matriz: ");
            ...
            System.out.println("3 | Realizando Operações.");
            //Realiza a multiplicação
            multiplicarMatrizes();
            System.out.println("3 | Operações concluídas.");
