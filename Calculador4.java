...
public class Calculador4{
	...
	public static void main( String[] args) {
        try {
            ...
            System.out.println("4| Aguardando uma conexão ...");
            Socket socket = server.accept();
            System.out.println("4| Aguardando um objeto ...");
            ObjectInputStream leitor = new ObjectInputStream(socket.getInputStream());
            MatrizPacote mp = (MatrizPacote) leitor.readObject();
            System.out.println("4 | Recebida a Matriz: ");
            ...
            System.out.println("4 | Realizando Operações.");
            //Realiza a multiplicação
            multiplicarMatrizes();
            System.out.println("4 | Operações concluídas.");
